...
class TestMercadolibreCategorySelector:
    ...
    def setup(self):
        ...
        self.p1 = ProductMaster.objects.create(code="P1", is_active=True, is_for_mercadolibre=True)
        # 2. Active, ML, No listing
        self.p2 = ProductMaster.objects.create(code="P2", is_active=True, is_for_mercadolibre=True)
        # 3. Active, ML, No listing
        self.p3 = ProductMaster.objects.create(code="P3", is_active=True, is_for_mercadolibre=True)
        # 4. Active, ML, With listing
        self.p4 = ProductMaster.objects.create(code="P4", is_active=True, is_for_mercadolibre=True)
        ...
        self.p5 = ProductMaster.objects.create(code="P5", is_active=False, is_for_mercadolibre=True)

        # 6. Active, Not ML, No listing
        self.p6 = ProductMaster.objects.create(code="P6", is_active=True, is_for_mercadolibre=False)
    ...
    def test_get_queryset_force_false(self):
        ...
        self.p7 = ProductMaster.objects.create(code="P7", is_active=True, is_for_mercadolibre=True)
        ...
        self.p8 = ProductMaster.objects.create(code="P8", is_active=True, is_for_mercadolibre=True)
