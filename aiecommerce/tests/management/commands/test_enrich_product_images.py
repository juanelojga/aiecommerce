...
def test_enrich_product_images_no_products(capsys):
    ...
    call_command("enrich_product_images")
...
@pytest.mark.django_db
@patch("aiecommerce.management.commands.enrich_product_images.process_product_image")
def test_enrich_product_images_dry_run(mock_process_product_image, capsys):
    """Test dry-run mode."""
    ...
    call_command("enrich_product_images", "--dry-run")
...
def test_enrich_product_images_normal_run(mock_sleep, mock_process_product_image, capsys):
...
def test_enrich_product_images_enqueue_failure(mock_sleep, mock_process_product_image, capsys):
